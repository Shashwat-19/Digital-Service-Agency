...
public class DigitalServiceAgency extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            DigitalServiceAgency app = new DigitalServiceAgency();
            app.setVisible(true);
        });
    }
}
